...
The student took a Smarter Balanced assessment based on the grade seven [Idaho Content Standards](http://sde.idaho.gov/academic/standards/) for mathematics and received an overall score that ranges from about 2000 to 3000.
...
### Standard Exceeded (Level 4): 2635–2964 {#desc-exceeded}
...
These three claims are based on [Idaho's Content Standards](http://sde.idaho.gov/academic/standards/), which describe the knowledge and skills students are expected to learn in grade seven.
